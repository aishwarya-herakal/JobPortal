...
export const About = () => {
  ...
  <div className="grid md:grid-cols-3 gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
    <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
      ...
      <p className="text-lg">
        At JobPortal, we're more than just a job application platform –
        ...
        seasoned professional seeking new horizons, JobPortal is here to
    ...
    <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
      <p className="text-2xl text-yellow-500">Join the JobPortalCommunity</p>
      <p className="pt-3">
        {" "}When you join JobPortal, you're not just signing up for a platform –
      ...
      <p className="pt-4">
        Thank you for choosing JobPortal as your partner in career
